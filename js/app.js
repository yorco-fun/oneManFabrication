(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) new swiper_core_Swiper(".swiper", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".item-about__arrow--left",
                nextEl: ".item-about__arrow--right"
            },
            on: {}
        });
        if (document.querySelector(".swiper-reverse")) new swiper_core_Swiper(".swiper-reverse", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".item-about__arrow-reverse--left",
                nextEl: ".item-about__arrow-reverse--right"
            },
            on: {}
        });
    }
